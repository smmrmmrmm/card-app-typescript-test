...
export default function EditEntry() {
  ...
  return (
    <section className="flex justify-center flex-col w-fit ml-auto mr-auto mt-10 gap-5 bg-gray-300 dark:bg-slate-700 p-8 rounded-md">
      <input
        className="p-3 rounded-md dark:bg-slate-800 dark:text-slate-200"
        type="text"
        placeholder="Title"
        name="title"
      ...
      <button
        ...
        className="bg-blue-400 dark:bg-slate-800 dark:hover:bg-slate-900 hover:bg-blue-600 font-semibold text-white dark:text-slate-200 p-3 rounded-md"
      >
        Update
      </button>
    </section>
